...
- `shell_params`:     pass custom parameters to `wkhtmltopdf` or `chrome-headless-render-pdf`. **CAUTION: BEWARE OF SHELL INJECTIONS!**. **CAUTION: BEWARE OF SHELL INJECTIONS!**
